...
module.exports =  async function DeleteHandler(req, reply) {
    try {
        ...
        let results = await dbclient.query(`DELETE from ${req.routeConfig.dbschema}.${req.routeConfig.table}  where ${req.routeConfig.identifier} = '${req.params[req.routeConfig.identifier]}'`)
