...
module.exports =  async function PutHandler(req, reply) {
    try {
        ...
        let consulta = `UPDATE ${req.routeConfig.dbschema}.${req.routeConfig.table} SET ${GetFields(req.body)} where ${req.routeConfig.identifier} = '${req.params[req.routeConfig.identifier]}'`
